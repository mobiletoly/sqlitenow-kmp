...
@file:JsModule("./sqlitenow-sqljs-fixture.js")
...
internal external fun dbExec(handle: Int, sql: String, onStatementExecuted: (String) -> Unit)
...
internal external fun stmtGetNormalizedSql(stmtHandle: Int): String
...
internal external fun stmtGetColumnType(stmtHandle: Int, columnIndex: Int): Int
...
internal external fun takeSqliteNowSuppressed(error: JsAny): JsArray<JsAny?>
internal external fun throwSqliteNowFailure(error: JsAny?)
