...
fun App() {
    ...
    var persons by remember { mutableStateOf<List<Person.SharedResult.Person>>(emptyList()) }
...
@Composable
fun PersonCard(
    person: Person.SharedResult.Person,
    onDelete: (Person.SharedResult.Person) -> Unit
) {
    Card(
        modifier = Modifier.fillMaxWidth(),
        elevation = 4.dp,
