...
class SqliteNowDartEmitterTest {
    ...
    fun compilerGeneratesDartVerticalSlice() {
        ...
        assertTrue(code.contains("SqliteNowMigrationStepCallback? onMigrationStep"))
        assertTrue(code.contains("onMigrationStep: onMigrationStep"))
    ...
    fun compilerGeneratesDartOversqliteMetadataAndHttpClientHelper() {
        ...
        assertEquals(2, Regex("SqliteNowMigrationStepCallback\\? onMigrationStep").findAll(code).count())
        assertEquals(2, Regex("onMigrationStep: onMigrationStep").findAll(code).count())
