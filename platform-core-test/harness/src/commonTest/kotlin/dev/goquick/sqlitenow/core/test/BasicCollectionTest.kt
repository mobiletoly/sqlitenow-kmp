...
class BasicCollectionTest {
    ...
    @Test
    fun testBasicCollectionMapping() = runDatabaseTest {
            database.open()
    ...
    @Test
    fun testCollectionMappingQueryRestrictions() = runDatabaseTest {
            database.open()
    ...
    @Test
    fun selectAllByLastNamesUsesCollectionParameter() = runDatabaseTest {
            database.open()
