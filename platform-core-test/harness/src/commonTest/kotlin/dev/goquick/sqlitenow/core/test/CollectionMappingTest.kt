...
class CollectionMappingTest {
    ...
    @Test
    fun testPerRowMapping() = runDatabaseTest {
        // Create test data
    ...
    @Test
    fun testCollectionMapping() = runDatabaseTest {
        // Create test data
    ...
    @Test
    fun testEmptyCollectionMapping() = runDatabaseTest {
    ...
    @Test
    fun testCollectionQueryRestrictions() = runDatabaseTest {
        // Create test data
        val person = database.person.add.one(PersonQuery.Add.Params(
            firstName = "Test",
            lastName = "User",
    ...
    @Test
    fun testManyToManyRelationships() = runDatabaseTest {
