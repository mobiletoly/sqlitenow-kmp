...
class NestedCollectionMappingTest {
    ...
    @Test
    fun testNestedCollectionsWithEmptyCollections() = runDatabaseTest {
    ...
    @Test
    fun testNestedCollectionsWithNonExistentPerson() = runDatabaseTest {
    ...
    @Test
    fun testNestedCollectionsDistinctBy() = runDatabaseTest {
    ...
    @Test
    fun testNestedCollectionsWithComplexJsonData() = runDatabaseTest {
        ...
        val comment1Tags = assertNotNull(comment1.tags)
        val comment2Tags = assertNotNull(comment2.tags)

        // Verify specific complex tag values
        assertTrue(comment1Tags.contains("unicode: 🚀🎉💻"))
        assertTrue(comment1Tags.contains("tag'with'quotes"))
        assertTrue(comment2Tags.contains("json{\"key\":\"value\"}"))
        assertTrue(comment2Tags.contains("newline\ncharacter"))
    }

    @Test
    fun testNestedCollectionsPerformanceWithLargeDataset() = runDatabaseTest {
        ...
        assertNotNull(firstComment)
        val firstCommentTags = assertNotNull(firstComment.tags)
        assertTrue(firstCommentTags.contains("performance"))
    ...
    @Test
    fun testNestedCollectionsDataConsistency() = runDatabaseTest {
    ...
    @Test
    fun testNestedCollectionsQueryRestrictions() = runDatabaseTest {
    ...
    @Test
    fun testPerRowMappingBasic() = runDatabaseTest {
    ...
    @Test
    fun testEntityMappingFromSingleTable() = runDatabaseTest {
    ...
    @Test
    fun testPerRowVsEntityMappingDifference() = runDatabaseTest {
        ...
        assertTrue(true, "Both perRow and entity mapping work, but use different data sources")
    }
}
