...
const platformEnabled =
  process.env.OVERSQLITE_PLATFORM_TESTS ?? null;
...
config.plugins.push(
  new webpack.BannerPlugin({
    ...
    entryOnly: true,
    banner: `
globalThis.OVERSQLITE_PLATFORM_TESTS = ${JSON.stringify(platformEnabled)};
...
globalThis.OVERSQLITE_REAL_SERVER_SMOKE_BASE_URL = ${JSON.stringify(realServerBaseUrl)};
`,
  }),
);
